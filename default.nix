...
let
  py2hwsw_commit = "a1e2e2ee12ca6e6ad81cc2f8f0f1c1d585aaee73"; # Replace with the desired commit.
  py2hwsw_sha256 = "sha256-5+QlwY5Syr+gvMzppIQ1j/uwOrrvJ+BxzLFMJhTv0eQ="; # Replace with the actual SHA256 hash.

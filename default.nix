...
let
  py2hwsw_commit = "0641d549f216fae5a92909b35cb3a2da66829cc1"; # Replace with the desired commit.
  py2hwsw_sha256 = "sha256-CSfZReMJ8jga3bTcl6A7OSDXaFMuakT4Do+b+xFusow="; # Replace with the actual SHA256 hash.
